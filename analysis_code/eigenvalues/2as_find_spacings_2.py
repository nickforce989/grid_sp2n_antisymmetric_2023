...
def merge_spacings_files(directory):
    input_file = os.path.join(directory, '../../data/eigenvalues/2as_spacings_density.txt')
    output_file = os.path.join(directory, '../../data/eigenvalues/spacings_density_2as.txt')
