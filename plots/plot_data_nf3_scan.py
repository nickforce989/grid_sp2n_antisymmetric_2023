...
for i in range(8):
    ...
    data = np.loadtxt(f'bulktrans_nf3_sp4_2AS_{i+1}.dat')  # assuming files are named as bulktrans_sp4_2AS_b56_1.dat, bulktrans_sp4_2AS_b56_2.dat, etc.
...
plt.savefig('bulktrans_nf3_2AS_all.pdf', dpi=300, bbox_inches='tight')
