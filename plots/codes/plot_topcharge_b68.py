...
data1_path = '../../data/TopCharge/top_charges_b68-am08_with_index.txt'
data2_path = '../../data/TopCharge/top_charges_b68-am08.txt'
if use_dp_flag:
    data1_path = '../../precomputed_data/TopCharge/top_charges_b68-am08_with_index.txt'
    data2_path = '../../precomputed_data/TopCharge/top_charges_b68-am08.txt'
...
ax1.text(0.02, 0.98, r'$\langle Q_L \rangle$ = {:.3f}({:.0f})'.format(
    np.mean(y), 1000 * np.std(y) / np.sqrt(2012)),
...
n, bins, patches = ax2.hist(data2_norm, bins=14, range=(-3, 3),
