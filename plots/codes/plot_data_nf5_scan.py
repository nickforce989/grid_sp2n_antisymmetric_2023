...
colors = [(0.0, 0.5, 0.5), (0.5, 0.0, 0.3), (0.3, 0.2, 0.4), (0.3, 0.2, 0.1),
          (0.4, 0.4, 0.4), (0.8, 0.8, 0.8), (0.8, 0.6, 0.4), (0.1, 0.1, 0.4)]
...
base_path = "../../data/Nf5_data/"
if use_dp:
    base_path = "../../precomputed_data/Nf5_data/"

# Create a figure and axis object
fig, ax = plt.subplots(figsize=(6, 3.5))

# Define a list of beta values
betas = [5.8, 6.0, 6.1, 6.2, 6.3, 6.4, 6.5, 6.6]

# Loop through each file
for i in range(8):
    # Construct the path based on the flag
    data_path = f"{base_path}bulktrans_nf5_sp4_2AS_{i+1}.dat"
