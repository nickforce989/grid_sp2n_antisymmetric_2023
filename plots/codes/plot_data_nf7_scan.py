...
# Check if the flag '--dp' is provided in the command line arguments
if "--dp" in sys.argv:
    data_path = "../../precomputed_data/Nf7_data/bulktrans_nf7_sp4_2AS_{}.dat"
else:
    data_path = "../../data/Nf7_data/bulktrans_nf7_sp4_2AS_{}.dat"

# Loop through each file
for i in range(6):
    # Read data from input file
    data = np.loadtxt(data_path.format(i+1))
...
plt.savefig('../figures/bulktrans_nf7_2AS_all.pdf', dpi=300, bbox_inches='tight')
