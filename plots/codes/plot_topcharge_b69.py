...
ax1.text(0.02, 0.98, r'$\langle Q_L \rangle$ = {:.3f}({:.0f})'.format(np.mean(y), 84), transform=ax1.transAxes, fontsize=12, verticalalignment='top', bbox=dict(facecolor='white', edgecolor='none', alpha=0.8))
...
n, bins, patches = ax2.hist(data2_norm, bins=13, range=(-3, 3), orientation='horizontal', density=True, edgecolor='black', linewidth=0.5)
